...
//       Snackbar.show({
//         text: error.message || t("failedToSendOTP"),
//         duration: 3000,
//         backgroundColor: "#B80200",
//         textColor: "#FFFFFF",
//       });
...
//       Snackbar.show({
//         text: error.message || t("failedToResetPassword"),
//         duration: 3000,
//         backgroundColor: "#B80200",
//         textColor: "#FFFFFF",
//       });
...
//       <Text style={[styles.title, rtlStyle]}>{t("resetPassword")}</Text>
//       <Text style={[styles.subtitle, rtlStyle]}>
//         {t("enterPhoneToResetPassword")}
//       </Text>
...
//   const renderOTPStep = () => (
//     <View style={styles.contentContainer}>
//       <Text style={[styles.title, rtlStyle]}>{t("verifyOTP")}</Text>
//       <Text style={[styles.subtitle, rtlStyle]}>
//         {t("otpSentToPhone", { phone })}
//       </Text>

//       {/* OTP Input */}
//       <View style={styles.inputGroup}>
//         <Text style={[styles.label, rtlStyle]}>{t("enterOTP")}</Text>
//         <View style={styles.inputContainer}>
//           <View
//             style={[
//               styles.iconContainer,
...
//             ]}
//           >
//             <Ionicons name="key-outline" size={20} color="#B80200" />
//           </View>
//           <TextInput
//             style={[styles.input, { textAlign: isRTL ? "right" : "left" }]}
//             value={otp}
...
//       {/* Timer and Resend */}
//       <View
//         style={[styles.timerContainer, { flexDirection: getFlexDirection() }]}
//       >
//         <Text style={[styles.timerText, rtlStyle]}>
//           {timer > 0
//             ? t("resendIn", { time: formatTime(timer) })
//             : t("didntReceiveOTP")}
//         </Text>
...
//           style={timer > 0 ? styles.resendDisabled : styles.resendEnabled}
//         >
//           <Text
//             style={[
//               styles.resendText,
...
//     <View style={styles.contentContainer}>
//       <Text style={[styles.title, rtlStyle]}>{t("createNewPassword")}</Text>
//       <Text style={[styles.subtitle, rtlStyle]}>
...
//       {/* New Password */}
//       <View style={styles.inputGroup}>
//         <Text style={[styles.label, rtlStyle]}>{t("newPassword")}</Text>
//         <View style={styles.inputContainer}>
//           <View
//             style={[
//               styles.iconContainer,
...
//             ]}
//           >
//             <Ionicons name="lock-closed-outline" size={20} color="#B80200" />
//           </View>
//           <TextInput
//             style={[styles.input, { textAlign: isRTL ? "right" : "left" }]}
//             value={newPassword}
...
//       {/* Confirm Password */}
//       <View style={styles.inputGroup}>
//         <Text style={[styles.label, rtlStyle]}>{t("confirmPassword")}</Text>
//         <View style={styles.inputContainer}>
//           <View
//             style={[
//               styles.iconContainer,
...
//       Snackbar.show({
//         text: t("currentPasswordRequired"),
//         duration: 2000,
//         backgroundColor: "#B80200",
//         textColor: "#FFFFFF",
//       })
...
//       Snackbar.show({
//         text: t("newPasswordMustBeDifferent"),
//         duration: 2000,
//         backgroundColor: "#B80200",
//         textColor: "#FFFFFF",
//       })
...
//     } catch (error: any) {
//       console.error("Reset Password: Error:", error)
//       const errorMessage = error.response?.data?.message || t("passwordResetError")
//       Snackbar.show({
//         text: errorMessage,
//         duration: 3000,
//         backgroundColor: "#B80200",
...
//             </TouchableOpacity>
//             <Text style={[styles.headerTitle, rtlStyle]}>{t("resetPassword")}</Text>
//             <View style={styles.placeholder} />
//           </View>
...
//               {/* Title */}
//               <Text style={[styles.title, rtlStyle]}>{t("resetPassword")}</Text>
//               <Text style={[styles.subtitle, rtlStyle]}>{t("resetPasswordSubtitle")}</Text>

//               {/* Current Password */}
//               <View style={styles.inputGroup}>
//                 <Text style={[styles.label, rtlStyle]}>{t("currentPassword")}</Text>
//                 <View style={styles.inputContainer}>
//                   <View style={[styles.iconContainer, isRTL ? styles.iconContainerRTL : null]}>
//                     <Ionicons name="lock-closed-outline" size={20} color="#B80200" />
//                   </View>
//                   <TextInput
//                     style={[styles.input, { textAlign: isRTL ? "right" : "left" }]}
...
//                     <Text style={[styles.submitButtonText, rtlStyle]}>{t("resetPassword")}</Text>
//                   </>
//                 )}
//               </TouchableOpacity>
//             </View>
