...
export default function CarDetails(): JSX.Element {
  ...
  const handleStartChat = async () => {
    ...
    if (ownerId === user._id) {
      Snackbar.show({
        text: t("cannot_chat_with_yourself"),
        duration: 1000,
        backgroundColor: "#b80200",
        textColor: "#fff",
      });
