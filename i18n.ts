...
const en = {
  invalid_email_or_password: "Invalid Phone number or Password",
  example_phone_number2: "",
  home: "Home",
  favorites: "Favorites",
  placeAd: "Place Ad",
  chat: "Chat",
  ...
  features: "Features",
  price_year_kilometer_place_holder: "Enter",
  ...
  Automatic: "Automatic",
  Manual: "Manual",
  password_statement: "Enter a number without leading 0",
  Sedan: "Sedan",
  SUV: "SUV",
  Coupe: "Coupe",
  ...
  model_from_car_details_screen: "Model",
  kilometer_from_car_detail_screen: "Kilometer",
  Price_for_filter: "Price :",
  Kilometers_for_filters: "Kilometer :",
  gallery_description: "You can rearrange pictures",
  make_from_car_details_screen: "Make",
  Beige: "Beige",
...
const ar = {
  Beige: "البيج",
  gallery_description: "يمكنك إعادة ترتيب الصور",
  Kilometers_for_filters: "كيلومتر :",
  Price_for_filter: "سعر ($):",
  make_from_car_details_screen: "النوع",
  kilometer_from_car_detail_screen: "الكيلومتر",
  model_from_car_details_screen: "الموديل",
  ...
  search_model: "بحث",
  searchModel: "بحث",
  select_make_first: "حدد النوع أولاً",
  ...
  Coupe: "كوبيه",
  Convertible: "مكشوفة",
  ThreeSixty_degree_camera: "كاميرا ٣٦٠ درجة",
  Blind_spot_warning: "تحذير النقطة العمياء",
  Adaptive_headlights: "مصابيح امامية تكيفية",
  Cooled_Seats: "مقاعد مبردة",
  Heated_seats: "مقاعد بتدفئة",
  LED_headlights: "LED مصابيح امامية",
  Performance_tyres: "اطارات اداء عالي",
  Sound_system: "نظام صوت",
  ABS: "مكابح مانعة للانغلاق ABS",
  Bluetooth: "نظام بلوتوث",
  Extensive_tool_kit: "صندوق ادوات الاصلاح",
  Keyless_start: "تشغيل بدون مفتاح",
  Memory_seat: "ذاكرة للمقاعد",
  Reversing_camera: "كاميرة خلفية",
  Traction_control: "مسند الرأس النشط",
  Active_head_restraints: "مراقبة النقطة العمياء",
  Blind_spot_alert: "مساعدة الفرامل",
  Forward_collision_warning: "تحذير الاصطدام الأمامي",
  Leather_seats: "مقاعد جلدية",
  Navigation_system: "نظام الملاحة",
  Side_airbags: "اكياس هواء جانبية",
  USB_port: "منفذ USB",

  messages: "رسائل",
  add_listing: "إضافة إعلان +",
  select_make: "حدد نوع السيارة",
  select_model: "حدد النموذج من الخيارات",
  year_placeholder: " أدخل السنة",
  year: "سنة",
  year_for_filer: "سنة :",
  price_usd: "سعر (دولار)",
  price_year_kilometer_place_holder: "يرجى كتابة الأرقام باللغة الإنجليزية",
  kilometer_placeholder: "أدخل كيلومترا",
  select_cylinders: "عدد الاسطوانات",
  select_location: "الموقع",
  select_transmission: "ناقل الحركة",
  select_fuel_type: "نوع الوقود",
  select_exterior_color: "اللون الخارجي",
  select_interior_color: "اللون الداخلي",
  gallery: "الصور",
  choose_images: "اختر الصور",
  number_of_cylinders: "عدد الاسطوانات",
  general_info: "معلومات عامة",
  add_listing2: "نشر الإعلان +",
  // test: "test",
  // test: "test",
  // test: "test",
  viewDetails: "عرض التفاصيل",
  fuelType: "نوع الوقود",
  report_abuse: "الإبلاغ عن الإعلان",
  you_may_also_like: "قد يهمك ايضاً …",
  ...
  engine_size: "عدد الاسطوانات",
  call: "يتصل",
  information: "نظرة عامة عن السيارة",
  make: "نوع السيارة",
  Make: "النوع",
  model: "الموديل",
  kilometer: "كيلومتر",
  ...
  recent_listings: "القوائم الحديثة",
  view_all: "عرض الكل",
  all_available_cars: "جميع السيارات المتاحة",
  view_details: "عرض التفاصيل",
  home: "الرئيسية",
  syria_souq: "سيريا سوق",
  favorites: "المفضلة",
  placeAd: "إضافة إعلان",
  chat: "دردشة",
  profile: "حسابي",
  ...
  profileTab: "حسابي",
  myListingsTab: "قائمتي",
  tapToChangePhoto: "تحميل صورة الملف الشخصي",
  ...
  noListings: "لا توجد سيارات متاحة الآن.",
  ...
  password_statement: "أدخل رقمًا بدون الصفر في البداية",
  deleteListingConfirmMessage:
